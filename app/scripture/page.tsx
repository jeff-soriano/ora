...
function BiblePassage({bibleVerse, bibleVerseCitation}: {bibleVerse: string, bibleVerseCitation: string}) {
  return (
...
function BibleVerseReflection({bibleVerseReflection}: {bibleVerseReflection: string}) {
  return (
...
export default async function ScripturePage() {
  ...
  return (
      <div className="min-h-screen flex flex-col items-center px-4 py-12 md:py-20 bg-background">
        ...
        {/* Scripture Block */}
        <BiblePassage bibleVerse={bibleVerse} bibleVerseCitation={bibleVerseCitation} />
