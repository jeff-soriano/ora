    ...
    <div className="min-h-[calc(100vh-64px)] flex flex-col items-center justify-center bg-[#f8f5ef] px-4 py-8">
      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="flex justify-center">
          <button className="bg-black text-white text-lg md:text-xl px-12 py-4 rounded-md hover:bg-gray-900 transition-colors font-semibold shadow-md hover:cursor-pointer">
            NEXT STEP
          </button>
        </div>
      </div>
